...
- **Capabilities install as packs.** Rich add-ons (design styles, Slack bots, etc.) live in `hq-packages` and install via `hq install @indigoai-us/hq-pack-*` — see [hq-packages](/hq/products/hq-packages/).
