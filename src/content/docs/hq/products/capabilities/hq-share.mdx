...
> **hq-share is a capability of the [`hq` CLI](/hq/products/hq-cli/), not a standalone repo.** It grants access to prefixes in the [hq-pro](/hq/products/hq-pro/) vault.
...
- [hq-pro](/hq/products/hq-pro/) — the vault whose prefixes you're sharing
